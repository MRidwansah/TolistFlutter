...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _load() async {
    final all = await StorageService.getNotes();
    // Home hanya tampilkan catatan yang sudah dipublish (bukan draft)
    if (mounted) setState(() { _notes = all.where((n) => !n.isDraft).toList(); _loading = false; });
  }
  ...
  Future<void> _toggleBookmark(Note note) async {
    ...
    _showToast(note.isBookmarked ? 'Ditambahkan ke bookmark' : 'Dihapus dari bookmark', note.isBookmarked);
  }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Icon(Icons.arrow_forward, color: AppColors.textSlate600, size: 12),
                        ),
                      ],
                    ),
