...
class _UploadScreenState extends State<UploadScreen> {
  ...
  bool _saving = false;
  // null = idle, 'draft' = baru simpan draft, 'publish' = baru publish
  String? _savedAs;
  ...
  Future<void> _pickFile() async {
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        setState(() { _pickedFile = file; _imageBase64 = null; });
        ...
        if (['jpg', 'jpeg', 'png'].contains(ext)) {
          ...
          if (mounted) setState(() => _imageBase64 = b64);
        }
      }
    } catch (e) {
  ...
  void _removeFile() => setState(() { _pickedFile = null; _imageBase64 = null; });
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                child: OutlinedButton(
                  ...
                  child: _saving
                      ...
                      : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Icon(
                            _savedAs == 'draft' ? Icons.check_rounded : Icons.drafts_outlined,
                            color: AppColors.amber, size: 16,
                          ),
                          const SizedBox(width: 6),
                          Text(
                            _savedAs == 'draft' ? 'Tersimpan!' : 'Simpan Draft',
                            style: GoogleFonts.inter(color: AppColors.amber, fontWeight: FontWeight.w700, fontSize: 13),
                          ),
                        ]),
                ),
              ),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: _saving
                      ...
                      : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Icon(
                            _savedAs == 'publish' ? Icons.check_rounded : Icons.cloud_upload_outlined,
                            size: 16,
                          ),
                          const SizedBox(width: 6),
                          Text(
                            _savedAs == 'publish' ? 'Terpublish!' : 'Publish',
            ...
            Row(children: [
              Expanded(child: Text(
                '💾 Draft: simpan dulu,\nselesaikan & publish nanti',
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(color: AppColors.textSlate600, fontSize: 10, height: 1.4),
              )),
              const SizedBox(width: 12),
              Expanded(child: Text(
                '🚀 Publish: langsung tampil\ndi halaman Home',
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(color: AppColors.textSlate600, fontSize: 10, height: 1.4),
              )),
            ]),
