...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    // Simpan akun ke storage agar bisa login
    await StorageService.saveRegisteredUser(username, email, password);

    if (!mounted) return;
    // Redirect ke login dulu (bukan langsung masuk)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Background glows — emerald theme for register
          Positioned(
            top: -100,
            right: -100,
            child: Container(
